...
const CommentSection = (props) =>{
    ...
    const showmoreHandler =(e)=>{
        e.preventDefault();
        setShow(!show);
        (itemNum >= comments.length -1 ? setItemNum(itemNum - 2) : setItemNum(itemNum + 3) );
    };
    return(
        <div className={styles.container}>
            ...
            <div className={styles.wrapper}>
                <div className={styles.comment}>
                   ...
                   <button className={styles.btn} onClick={showmoreHandler}><span>&larr;</span>{show ? " بستن" : " بیشتر"}</button>
                </div>
            </div>
