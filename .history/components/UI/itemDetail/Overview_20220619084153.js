...
const Overview = (props) =>{
    ...
    const {availbleColors = ["blue","red","sss"], availbleSize=["L", "XL","XLL"], property =["ساده", "ساده", "ساده", "ساده", ]
    , commentNum = 45, title ="پولو شرت", price= 200000, off = "52%", priceWithOff= 100101, imgs =["/static/img/itemsImg/item1.png","/static/img/itemsImg/1.png","/static/img/itemsImg/1-1.png"]} = props.item;
