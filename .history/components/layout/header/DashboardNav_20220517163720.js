                ...
                <div className={styles.navWrapper}>
                    {/* <div className={styles.nav}> */}
                        <ul className={styles.navItems}>
                            <li className={styles.navItem}><Link href="/"><a>خلاصه فعالیت</a></Link></li>
                            <li className={styles.navItem}><Link href={`/`}><a>سفارشات </a></Link> </li>
                            <li className={styles.navItem}><Link href={`/`}><a>آدرس ها </a></Link> </li>
