                ...
                <div className={styles.nav}>
                    <div className={styles.rightNav}>
                        <ul className={styles.navItems}>
                            ...
                            <li className={cls(styles.navItem, (url=="/main-category/women" &&styles.active) )}><Link href={`/main-category/${["women"]}`}><a>زنانه </a></Link> </li>
                            <li className={cls(styles.navItem, (url=="/main-category/men" &&styles.active) )}><Link href={`/main-category/${["men"]}`}><a>مردانه </a></Link> </li>
                            <li className={cls(styles.navItem, (url=="/main-category/kids" &&styles.active) )}><Link href={`/main-category/${["kids"]}`}><a>بچگانه </a></Link> </li>
                        </ul>
                    </div>
