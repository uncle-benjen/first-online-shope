...
import { magic ,isUserLoggedIn } from "../../../lib/magicClient";
...
userLoggedIn().then((res)=>{
  if (res) {
        ...
        // alert("You r logged Out, loggin again");
      }
    });
  getUserEmail().then(res=>{
    ...
    const dashbourdHandler = (e) =>{
      e.preventDefault();
      isUserLoggedIn ? router.push("/user/dashboard") : router.push("/");
      ;
