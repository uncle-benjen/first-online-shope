...
export const userOrders= [
    {id:1, orders:[2, 3, 4],totalPrice:"2000000"},
    {id:2, orders:[6, 2, 12],totalPrice:"5000000"},
];

export const orderitems = allItems.filter(item => userOrders.orders.includes(item.id))