...
export const userOrders= [
    {id:1, itemsId:[2, 3, 4],totalPrice:"2000000",orders:allItems.filter(item => userOrders.itemsId.includes(item.id))},
    {id:2, itemsId:[6, 2, 12],totalPrice:"5000000",orders:allItems.filter(item => userOrders.itemsId.includes(item.id))},
];
