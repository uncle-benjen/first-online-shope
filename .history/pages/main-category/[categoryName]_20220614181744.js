...
const CategoryName = () =>{
    ...
    if (name === "men") {
        ...
        category = [
        {name:"تیشرت", url:"/main-category/men", img:"/static/img/womenSection.jpg"},
        {name:"پیراهن", url:"/main-category/men", img:"/static/img/womenFormal.png"},
        ...
        category = [
        {name:"تیشرت", url:"/main-category/men", img:"/static/img/menSection.jpg"},
        {name:"پیراهن", url:"/main-category/men", img:"/static/img/menFormal.png"},
        {name:"زمستانی", url:"/main-category/men", img:"/static/img/menHoodi.jpg"},
    ];
    }
