...
const UserDashboard = () =>{
    ...
    const userDataArray =[{email: "", userName :""}];
    ...
    userEmail().then(res =>{
        ...
        setUserData({...userData, email : user.email, userName:createUserName(user.email)});
    });
    ...
    return(
        <div className={styles.wrapper}>
            <div className={cls(styles.nav, active && styles.active)}> 
                <DashboardNav navState={navActive} email={userData.email} userName={userData.userName}/> 
